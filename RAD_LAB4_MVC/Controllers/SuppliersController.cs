...
namespace RAD_LAB4_MVC.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,AddressLine1,AddressLine2")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,AddressLine1,AddressLine2")] Supplier supplier)
        {
            if (id != supplier.ID)
            {
                return NotFound();
